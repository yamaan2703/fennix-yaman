        ...
        >
            <div className="relative z-10">
                ...
                <h2 className="text-2xl sm:text-3xl md:text-4xl font-semibold text-gray-900 mb-6 leading-tight">
                    How you came to know about Fennix?
                ...
                <div className="flex justify-center">
                    <button
                        ...
                        className={`group inline-flex items-center gap-2 px-8 py-3 rounded-full font-semibold text-sm transition-all duration-300 ${selectedSource
