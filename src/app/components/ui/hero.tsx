      ...
      >
        {gradient && (
          <div className="absolute top-0 isolate z-0 flex w-screen flex-1 items-start justify-center">
            ...
            {/* Main glow */}
            <div className="absolute inset-auto z-50 h-36 w-[28rem] -translate-y-[30%] rounded-full bg-white/40 opacity-80 blur-3xl" />
            ...
            <motion.div
              ...
              className="absolute inset-auto z-50 h-0.5 -translate-y-[10%] bg-white/40"
            />
            ...
            <motion.div
              ...
              className="absolute inset-auto right-1/2 h-56 overflow-visible w-[30rem] bg-gradient-conic from-white/40 via-transparent to-transparent [--conic-position:from_70deg_at_center_top]"
            >
            ...
            <motion.div
              ...
              className="absolute inset-auto left-1/2 h-56 w-[30rem] bg-gradient-conic from-transparent via-transparent to-white/40 [--conic-position:from_290deg_at_center_top]"
            >
